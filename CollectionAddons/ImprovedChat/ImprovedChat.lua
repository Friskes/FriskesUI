...
local SPAMM_PATTERNS = {
    ...
    --"Гриб Ракетокрыл кричит: Только что прилетел дирижабль, который отправится в крепость Песни Войны! Все на борт! Мы летим в Борейскую тундру!",
    'Разделение добычи производится по системе "Групповая очередь".',
    'Разделение добычи производится по системе "Приоритет по нужности".',
    'Обыск производится по системе "Ответственный за добычу".',
    'Обыск производится по системе "По очереди".',
    'Обыск производится по системе "Каждый за себя".',
    'Разыгрываются только предметы качества "Необычное" и выше.',
    'Разыгрываются только предметы качества "Редкое" и выше.',
    'Разыгрываются только предметы качества "Превосходное" и выше.',
    "Установленный режим сложности подземелья: 5 игроков.",
    "Установленный режим сложности подземелья: 5 игроков (героич.).",
    "Установленный режим сложности рейда: 25 игроков.",
    "Установленный режим сложности рейда: 25 игроков (героич.).",
    "Установленный режим сложности рейда: 10 игроков.",
    "Установленный режим сложности рейда: 10 игроков (героич.).",
    ...
    "Состояние очереди для Все арены (Уровень: с 80 до 80)",
}

-- отключаем надоедливое сообщение: Ошибка интерфейсной операции, вызванная модификацией
